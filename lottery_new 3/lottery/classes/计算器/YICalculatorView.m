...
//	lblDisplay2.userInteractionEnabled = YES;
    ...
    // 删除退格键
    UIButton *deleteBtn = [self btnCalculatorWithSuperView:view tag:OPERATOR_DELETE title:@"back"];
    ...
    // 清除键
    UIButton *clearBtn = [self btnCalculatorWithSuperView:view tag:OPERATOR_CLEAR title:@"reset"];
