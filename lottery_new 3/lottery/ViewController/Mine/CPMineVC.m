...
//    320/184
    ...
    if ([CPGlobalDataManager shareGlobalData].isReviewVersion) {
        ...
        _modelList = @[
                       ...
                       [CPMineActionModel modelName:@"签到记录" icon:@"geren_tubiao_hb_goucai_mine" identify:8],
        ...
        _modelList = @[[CPMineActionModel modelName:@"我的推荐[推荐好友获取收益]" icon:@"shezhi_04_goucai_mine" identify:1],
                       [CPMineActionModel modelName:@"系统公告" icon:@"geren_tubiao_06_goucai_mine" identify:2],
                       ...
                       [CPMineActionModel modelName:@"我的红包" icon:@"geren_tubiao_hb_goucai_mine" identify:10],
                       [CPMineActionModel modelName:@"个人消息" icon:@"geren_tubiao_06_goucai_mine" identify:9]
                       ];
...
- (IBAction)buttonActions:(UIButton *)sender {
    ...
    switch (sender.tag) {
        ...
        {
            //手机购彩
            NSString *urlString = [[CPGlobalDataManager shareGlobalData].domainUrlString wayStringByAppendingPathComponent:@"/common/app/down1"];
            CPWebViewController *toWebVC = [[CPWebViewController alloc]cpWebWithURLString:urlString];
