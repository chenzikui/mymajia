...
- (void)loadPyqSampleView {
	...
	contentLbl.text = @"Friends circle - Nine Palace sub map, the effect is as follows:";
...
- (void)cropViewWithWith:(CGFloat)w height:(CGFloat)h {
	...
	CGRect rectView = CGRectMake(60 + (widthView+separtor) * w, 80 + (widthView+separtor) * h, widthView, widthView);
