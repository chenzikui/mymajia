...
- (void)newCodeChooose
{
    ...
    } cancelButtonTitle:@"cancel" destructiveButtonTitle:nil otherButtonTitle:@"QR code+logo",@"Two dimensional code color",@"Foreground color and background color of two-dimensional code",@"Commodity bar code",@"code93(Alipay barcode payment)",nil];
}
