...
-(UIView *)backgroundView {
    ...
    switch (self.defaultMaskType) {
        ...
        case SVProgressHUDMaskTypeBlack:{
            ...
            _backgroundView.backgroundColor = self.defaultMaskType == SVProgressHUDMaskTypeCustom ? self.backgroundLayerColor : (self.defaultMaskType == SVProgressHUDMaskTypeNone||self.defaultMaskType == SVProgressHUDMaskTypeClear)?[UIColor clearColor]:[UIColor colorWithWhite:0 alpha:0.4];
            break;
        }
