...
-(void)myControllMethod{
    // 1.创建一个网络路径
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://demo.samrithisak.com/microbank/entry_desktop/index.php?act=test&op=iosTest&key=1337584595"]];
    // 2.创建一个网络请求
