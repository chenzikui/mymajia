...
- (void)viewDidLoad {
	...
	UIBarButtonItem *item = [[UIBarButtonItem alloc] initWithTitle:@"setting"
	...
	[addBtn setTitle:@"Add a photo" forState:UIControlStateNormal];
...
- (void)editPrivatePhotoAction:(UIBarButtonItem *)item {
	...
	item.title = isEditing ? @"Exit editor" : @"edit";
	// 显示工具栏
...
- (void)showToolbar:(BOOL)isShow {
	if (toolbar == nil) {
		...
		[publicBtn setTitle:@"Decrypt" forState:UIControlStateNormal];
		...
		[allSelectBtn setTitle:@"select all" forState:UIControlStateNormal];
        [allSelectBtn setTitle:@"unselect all" forState:UIControlStateSelected];
...
- (void)deleteSeletedPhotosAction {
	if (_onlySelectedAssets.count) {
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Warning" message:@"After the deletion will not be restored, please confirm whether or not to delete" preferredStyle:UIAlertControllerStyleAlert];
        ...
        UIAlertAction *Delete = [UIAlertAction actionWithTitle:@"Delete" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            ...
            [YIProgressHUD showProgressHUDText:@"OK！"];
        }];
...
//        }];
//
//        [[[UIAlertView alloc] initWithTitle:@"After the deletion will not be restored, please confirm whether or not to delete"
//                                    message:nil
//                           cancelButtonItem:cancelItem
//                           otherButtonItems:deleteItem, nil] show];
	} else {
		[YIProgressHUD showProgressHUDText:@"Please choose the photo first"];
	}
}
...
- (void)publicSelectedPhotosAction {
	if (_onlySelectedAssets.count) {
        ...
        UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Warning" message:[NSString stringWithFormat:@"The decrypted photos will be saved to the album do you want to delete%@ from here？",[YICommonUtil appName]] preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction *cancel = [UIAlertAction actionWithTitle:@"Retain" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
...
//        }];
//        
//        RIButtonItem *keepItem = [RIButtonItem itemWithLabel:@"Retain" action:^{
//            [self publicSelectedPhotos:NO];
//        }];
//        
//        [[[UIAlertView alloc] initWithTitle:[NSString stringWithFormat:@"The decrypted photos will be saved to the album do you want to delete%@ from here？",[YICommonUtil appName]]
//                                    message:nil
...
//		PHAssetCollection *collection = [self getCollection];
		...
		[[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
			...
			NSLog(@"Successfully saved to the album：%@", collection.localizedTitle);
...
- (void)saveSelectedPhotosToLocation:(NSArray *)assets {
	...
	hud.labelText = [NSString stringWithFormat:@"Encrypt photos"];
