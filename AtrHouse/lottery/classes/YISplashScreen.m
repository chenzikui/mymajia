...
//    sloganLbl.text = @"The future of the world \n because of the small and beautiful";
...
//    [poweredBtn setTitle:@"POWERED BY ArtHome" forState:UIControlStateNormal];
